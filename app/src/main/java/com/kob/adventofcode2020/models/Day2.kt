...
object Day2 {
    ...
    fun countMatch() : Int{
        ...
        for (value in array){
            ...
            val temps = keys[0].split(" ")
            val rangs = temps[0].split("-")
            val char = temps[1][0]

            try {
                val start = rangs[0].toInt()
                val end = rangs[1].toInt()
                val pass = keys[1].trim()
//                Log.e("countMatch", "start $start")
//                Log.e("countMatch", "end $end")
//                Log.e("countMatch", "pass $pass")
//                Log.e("countMatch", "index $index")

                val c = pass.toCharArray().filter { it == char }.count()
                if(c in start..end){
                    count++
                }
            }catch (e : Exception){
                Log.e("countMatch", "error $value")
            }
        }
    ...
    fun countMatch2() : Int{
        ...
        for (value in array){
            ...
            try {
                val start = rangs[0].toInt()-1
                val end = rangs[1].toInt()-1
                val pass = keys[1].trim()
//                Log.e("countMatch", "start $start")
//                Log.e("countMatch", "end $end")
//                Log.e("countMatch", "pass $pass")
//                Log.e("countMatch", "index $index")
                ...
                val firstValid = pass[start] == char
                val lastValid = pass[end] == char
                if(firstValid){
                    if(!lastValid){
                        count++
                    }
